...
if __name__ == "__main__":
    ...
    bool, proj_id = DB.fetch_id("Git3345", "projects")
    print(proj_id)
    #node_idd, Success1 = DB.new_node(proj_id, ["123"], ["Important info3345"], {"hi": "bye"})
    #node_idd2, Success4 = DB.new_node(proj_id, ["123"], ["Important info3345 DEST"], {"hi": "bye"})
    vein_idd, Success3 = DB.new_vein(proj_id, ["123"], "Important info3", {"origin": "67e1060a24b8276095ef104e", "destination": "67e110d4c87147cf27cbf288"})
    ...
    #print(DB.fetch_files("123", ObjectId('67e0ffbc68a12b6123de551e')))
